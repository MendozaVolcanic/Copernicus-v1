...
# Tamaños ajustados para que ambos tipos muestren la misma área física
# RGB: 10m/px → 1024px × 10m = 10,240m
# Thermal: 20m/px → Para mostrar la misma área, necesita 512px × 20m = 10,240m
IMAGE_WIDTH_RGB = 1024
IMAGE_HEIGHT_RGB = 1024
IMAGE_WIDTH_THERMAL = 512  # Mitad del tamaño para compensar doble resolución
