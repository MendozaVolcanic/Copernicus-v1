...
# Ambos tipos usan el mismo tamaño de imagen (1024×1024)
# RGB: 10m/px → Mayor detalle en la misma área
# Thermal: 20m/px → Menor detalle en la misma área
# El bbox (radio) determina el área física mostrada, NO la resolución
IMAGE_WIDTH_RGB = 1024
IMAGE_HEIGHT_RGB = 1024
IMAGE_WIDTH_THERMAL = 1024  # REVERTIDO: Mismo tamaño que RGB
IMAGE_HEIGHT_THERMAL = 1024
